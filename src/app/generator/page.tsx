...
export default function GeneratePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white p-8">
      <h1 className="text-3xl font-bold mb-4">Shark AI — Генерация</h1>
      ...
      <input value={prompt} onChange={(e) => setPrompt(e.target.value)} placeholder="Опишите, что создать..." className="bg-gray-800 rounded px-3 py-2 mr-2 flex-1" />
